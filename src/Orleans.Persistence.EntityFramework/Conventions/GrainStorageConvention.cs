...
using Orleans.Persistence.EntityFramework.Internal;
    ...
    IServiceScopeFactory serviceScopeFactory) : IGrainStorageConvention
{
    ...
    public virtual Action<IGrainState<TEntity>, TEntity> GetSetterFunc<TGrainState, TEntity>() where TEntity : class
    {
        return (state, entity) => state.State = entity;
    }

    public virtual Func<IGrainState<TEntity>, TEntity> GetGetterFunc<TGrainState, TEntity>() where TEntity : class
    {
